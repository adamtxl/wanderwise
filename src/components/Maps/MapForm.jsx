      ...
      return (
         <>
            <form onSubmit={this.onSubmit}>
               ...
               <p>Use <a href="https://www.latlong.net/">LatLong.net</a> to get Latitude / Longitude points. After adding the map, the map will auto-update 
               but it will not auto-update to show all pins (thats up to the user)</p>
